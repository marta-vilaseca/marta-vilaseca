# 👋 Hi! I'm Marta — a frontend developer with a strong design background and a soft spot for well-crafted interfaces (and cats).

💻 I work at the intersection of frontend development, design, and UX, building interfaces that are both visually intentional and performant. My background in graphic design and illustration strongly shapes how I think about structure, interaction, and user experience.

🌱 Lately, I’ve been:

- deepening my frontend and full-stack skills
- collaborating as a **teacher assistant in an AI course for developers**
- contributing to a **non-profit organization supporting junior developers**
- exploring ways to make complex ideas more accessible through code and design

🤝 I enjoy collaborating on **open source projects**, educational initiatives, and community-driven work where thoughtful frontend and good UX make a real difference.

🎮 Outside of code, I’m into art, gaming (video & board games), music, good food, and language learning — currently focused on Japanese.

<br />   

![GitHub User's stars](https://img.shields.io/github/stars/marta-vilaseca)
